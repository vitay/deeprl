...
![Dense vs. sparse rewradsSource: <https://forns.lmu.build/classes/spring-2020/cmsi-432/lecture-13-2.html>](img/sparse-dense.png){#fig-sparserewards}
...
![Sequence of states over time in a MDP.](img/rl-sequence.png){#fig-rl-sequence}
...
Depending on the value of $\gamma$, the optimal action might be $a_1$ or $a_2$, depnding on which one brings more reward **on the long term**.
