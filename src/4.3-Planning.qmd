...
Model-based learning is not only used to augment MF methods with imaginary rollouts. It can also be used directly for planning, as the model $s', r = M(s, a)$ can emulate complete trajectories and estimate their return. 
...
## Temporal difference models - TDM {#sec-tdm}
