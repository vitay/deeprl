...
![Dynamic programming alternates between policy evaluation and policy improvement. Source: @Sutton1998.](img/dynamicprogramming.png){#fig-dynamicprogramming width=20%}
