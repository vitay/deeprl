...
pdf: DeepRL.md
	pandoc -s -F pandoc-crossref --toc --bibliography=/home/vitay/Articles/biblio/ReinforcementLearning.bib \
...
html: DeepRL.md
	pandoc -N -F pandoc-crossref --template=default.html5 --mathjax="/usr/share/mathjax/MathJax.js?config=TeX-AMS-MML_HTMLorMML" \
